...
import com.assoft.peekster.databinding.ActivityStreamPlayerBinding
...
class StreamMediaPlayerActivity : Activity(), IVLCVout.Callback,
    SeekBar.OnSeekBarChangeListener {

    /** Internal variable for obtaining the [ActivityVideoPlayerBinding] binding. */
    private val binding: ActivityStreamPlayerBinding by contentView(R.layout.activity_stream_player)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            lifecycleOwner = this@StreamMediaPlayerActivity

            seekBar.setOnSeekBarChangeListener(this@StreamMediaPlayerActivity)
    ...
    private fun createMediaPlayer(url: String?) {
        try {
            ...
            binding.seekBar.max = (media.duration / 1000).toInt()
    ...
    private fun releasePlayer() {
        ...
        vOut.removeCallback(this@StreamMediaPlayerActivity)
        vOut.detachViews()
